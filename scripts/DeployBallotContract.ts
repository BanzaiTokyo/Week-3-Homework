...
import {createPublicClient, createWalletClient, formatEther, http, toHex} from "viem";
...
const loadArgs = (): { tokenContractAddress: `0x${string}`, targetBlockNumber: bigint, proposals: string[] } => {
